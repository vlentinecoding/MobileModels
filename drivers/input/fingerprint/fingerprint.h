...
enum tp_fp_event {
	TP_EVENT_SCREEN_ON_FINGER_DOWN = 0,
	TP_EVENT_SCREEN_ON_FINGER_UP = 1,
	TP_EVENT_HOVER_DOWN = 2,
	TP_EVENT_HOVER_UP = 3,
	TP_EVENT_SCREEN_OFF_FINGER_DOWN = 5,
	TP_EVENT_SCREEN_OFF_FINGER_UP = 6,
	TP_FP_EVENT_MAX,
};
