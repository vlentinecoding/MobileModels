...
#define NPU_MAX_SINK_SHORT_STREAM_ID    352
#define NPU_MAX_SINK_LONG_STREAM_ID     32
#define NPU_MAX_NON_SINK_STREAM_ID      256
...
#define NPU_INFO_OCCUPY_SIZE \
	((NPU_SQ_INFO_OCCUPY_SIZE) + (NPU_CQ_INFO_OCCUPY_SIZE) + \
		...
		(NPU_PROFILINGL_INFO_OCCUPY_SIZE))
