...
#define FASTBOOT_SEC_DATA_ADDR HISI_BL2_DDR_SHMEM_ADDR
...
#define FASTBOOT_INFO_DATA_SIZE (HISI_BL2_DDR_SHMEM_SIZE - (FASTBOOT_INFO_DATA_ADDR - FASTBOOT_SEC_DATA_ADDR))
#ifndef DDR_EDA
