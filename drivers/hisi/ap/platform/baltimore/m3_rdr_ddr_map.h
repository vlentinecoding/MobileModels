...
#define M3_RDR_DDR_LOWPOWER_TIME_ADDR (M3_RDR_SYS_CONTEXT_BASE_ADDR + M3_RDR_DDR_LOWPOWER_TIME_OFFSET)
#define M3_RDR_DDR_LOWPOWER_TIME_SIZE (0x280)
#define M3_RDR_SYS_CONTEXT_RESERVED_ADDR (M3_RDR_DDR_LOWPOWER_TIME_ADDR + M3_RDR_DDR_LOWPOWER_TIME_SIZE)
