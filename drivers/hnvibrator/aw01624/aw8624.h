...
#define LONG_HAPTIC_RTP_MAX_ID                  200
#define LONG_HAPTIC_RTP_MIN_ID                  1010

#define SHORT_HAPTIC_RAM_MAX_ID                 169
...
struct aw8624 {
	...
	struct work_struct real_time_rtp_work;
...
struct hn_aw8624_container {
       int len;
       unsigned char *data;
};
struct aw8624_receive_wave{
	uint32_t length;
    uint32_t magnitude;
	uint32_t playRateHz;
...
#define HAPWRAP_IOC_MAGIC AW8624_HAPTIC_IOCTL_MAGIC
...
#define HAPWRAP_SET_FIFO \
	_IOWR(HAPWRAP_IOC_MAGIC, 8, struct aw8624_receive_wave)
#define HAPWRAP_SET_VMAX     _IOW(HAPWRAP_IOC_MAGIC, 0x09, unsigned int)
#define HAPWRAP_GET_VMAX     _IOR(HAPWRAP_IOC_MAGIC, 0x0a, unsigned int *)
#define HAPWRAP_GET_F0       _IOR(HAPWRAP_IOC_MAGIC, 0x0b, unsigned int *)
