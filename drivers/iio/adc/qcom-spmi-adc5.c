...
static const struct adc5_channels adc7_chans_pmic[ADC5_MAX_CHANNEL] = {
	...
	[ADC7_GPIO4_100K_PU]	= ADC5_CHAN_TEMP("gpio4_pu2", 0,
					SCALE_HW_CALIB_THERM_100K_PU_PM7)
	/* antenna_board channel number 0x2a, Pin: GPIO_02 */
	[ADC7_GPIO1_30K_PU] = ADC5_CHAN_VOLT("antenna", 0,
					SCALE_HW_CALIB_DEFAULT)
};

static const struct adc5_channels adc7_8350_chans_pmic[ADC5_MAX_CHANNEL] = {
	[ADC7_REF_GND]		= ADC5_CHAN_VOLT("ref_gnd", 0,
					SCALE_HW_CALIB_DEFAULT)
	[ADC7_1P25VREF]		= ADC5_CHAN_VOLT("vref_1p25", 0,
					SCALE_HW_CALIB_DEFAULT)
	...
	[ADC7_GPIO2_100K_PU]	= ADC5_CHAN_TEMP("gpio2_pu2", 0,
					SCALE_HW_CALIB_THERM_100K_PU_PM7)
	/* antenna_board channel number 0x4c, Pin: GPIO_04 */
	[ADC7_GPIO3_100K_PU] = ADC5_CHAN_VOLT("antenna", 0,
					SCALE_HW_CALIB_DEFAULT)
	[ADC7_GPIO4_100K_PU]	= ADC5_CHAN_TEMP("gpio4_pu2", 0,
					SCALE_HW_CALIB_THERM_100K_PU_PM7)
};
...
static const struct adc5_data adc7_8350_data_pmic = {
	.name = "pm-adc7-8350",
	.full_scale_code_volt = 0x70e4,
	.adc_chans = adc7_8350_chans_pmic,
	.decimation = (unsigned int [ADC5_DECIMATION_SAMPLES_MAX])
				{85, 340, 1360},
	.hw_settle_2 = (unsigned int [VADC_HW_SETTLE_SAMPLES_MAX])
				{15, 100, 200, 300, 400, 500, 600, 700,
...
static const struct of_device_id adc5_match_table[] = {
	...
	{
		.compatible = "qcom,spmi-8350-adc7",
		.data = &adc7_8350_data_pmic,
	},
	{
...
static int adc5_probe(struct platform_device *pdev)
{
	...
	if (of_device_is_compatible(node, "qcom,spmi-adc7")
		|| of_device_is_compatible(node, "qcom,spmi-8350-adc7")) {
