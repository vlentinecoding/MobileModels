...
#define MAX_NAME_STR_LEN               62
#define MAX_CHDATA_STR_LEN             128
...
#define REPORT_DATA_LEN                62
#define REPORT_CALI_LEN                64
#define BUF_DATA_0                       0
#define BUF_DATA_1                       1
#define BUF_DATA_2                       2
#define BUF_DATA_3                       3
...
struct color_chip {
	...
	void (*at_color_store_calibrate_state)(struct color_chip *,
		struct at_color_sensor_input_t *);
	char *(*at_color_show_calibrate_state)(struct color_chip *,
		struct at_color_sensor_output_t *);
	...
	char *(*color_chip_vendor)(void);
	int (*color_chip_version)(void);
	int (*color_chip_type)(void);
	char *(*color_chip_max_range)(void);
	char *(*color_chip_resolution)(void);
	char *(*color_chip_sensor_report_data)(void);
	int (*color_chip_min_delay)(void);
	int (*color_chip_fifo_reserved_event_count)(void);
	int (*color_chip_fifo_max_event_count)(void);
	INT32 (*color_chip_get_atime)(struct color_chip *);
	UINT32 (*color_chip_get_itime)(struct color_chip *);
};
