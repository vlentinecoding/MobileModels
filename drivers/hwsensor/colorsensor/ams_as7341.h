...
#define AS7341_ITIME_MAX                                 250
#define AS7341_ITIME_STEP                                 50
...
#define AS7341_VERSION                   1
#define AS7341_TYPE                      0x1002C
#define AS7341_MIN_DELAY                 0
#define AS7341_FIFO_RESERVED_EVENT_COUNT 0
#define AS7341_MAX_EVENT_COUNT           0
#define AMS_REPORT_DATA_LEN              10
#define AS7341_CALIBRATE_RESULT_LEN      64
#define AS7341_CHANNEL                   11
#define AS7341_DATA_CHANNEL              10
#define AS7341_RETRY                     5
#define AS7341_DELAY_50US                50
#define AS7341_DELAY_200US               200
#define AS7341_DELAY_300US               300
#define AS7341_ASTEP_SCALE               1000
#define AS7341_CHDATA_LEN                12
char channel_data[MAX_CHDATA_STR_LEN] = {0};
char calibrate_result[AS7341_CALIBRATE_RESULT_LEN] = {0};
enum channel_names {
	CHAN_F1 = 0,
	CHAN_F2 = 1,
	CHAN_F3 = 2,
