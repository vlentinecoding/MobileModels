...
static void turn_off_taexception(const char *param)
{
	(void)param;
	ta_exception_enable = false;
}
static void turn_on_taexception(const char *param)
{
	(void)param;
	ta_exception_enable = true;
}
...
static struct opt_ops g_opt_arr[] = {
	...
	{"off_ta_exception", turn_off_taexception},
	{"on_ta_exception", turn_on_taexception},
};
