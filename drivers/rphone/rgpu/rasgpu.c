...
static int rasprobe_handler_entry(hisi_powerkey_down_hdl)
	(struct rasprobe_instance *ri, struct pt_regs *regs)
{
	struct RasRegs *rr = NULL;
	struct fault_impl *fault = fault_include(FAULT_CHIPSET_HUNG);
...
static int rasprobe_handler_entry(hisi_powerkey_up_hdl)
	(struct rasprobe_instance *ri, struct pt_regs *regs)
{
	struct RasRegs *rr = NULL;
	struct fault_impl *fault = fault_include(FAULT_CHIPSET_HUNG);
...
static int rasprobe_handler_entry(hisi_powerkey_1s_hdl)
	(struct rasprobe_instance *ri, struct pt_regs *regs)
{
	struct RasRegs *rr = NULL;
	struct fault_impl *fault = fault_include(FAULT_CHIPSET_HUNG);
...
static int rasprobe_handler_entry(hisi_powerkey_6s_hdl)
	(struct rasprobe_instance *ri, struct pt_regs *regs)
{
	struct RasRegs *rr = NULL;
	struct fault_impl *fault = fault_include(FAULT_CHIPSET_HUNG);
...
static int rasprobe_handler_entry(hisi_powerkey_8s_hdl)
	(struct rasprobe_instance *ri, struct pt_regs *regs)
{
	struct RasRegs *rr = NULL;
	struct fault_impl *fault = fault_include(FAULT_CHIPSET_HUNG);
...
static int rasprobe_handler_entry(hisi_powerkey_10s_hdl)
	(struct rasprobe_instance *ri, struct pt_regs *regs)
{
	struct RasRegs *rr = NULL;
	struct fault_impl *fault = fault_include(FAULT_CHIPSET_HUNG);
...
#else
rasprobe_entry_define(hisi_powerkey_down_hdl);/*chipset_hang*/
rasprobe_entry_define(hisi_powerkey_up_hdl);/*chipset_hang*/
rasprobe_entry_define(hisi_powerkey_1s_hdl);/*chipset_hang*/
rasprobe_entry_define(hisi_powerkey_6s_hdl);/*chipset_hang*/
rasprobe_entry_define(hisi_powerkey_8s_hdl);/*chipset_hang*/
rasprobe_entry_define(hisi_powerkey_10s_hdl);/*chipset_hang*/
#endif
...
static struct rasprobe *probes[] = {
	...
	#else
	&rasprobe_name(hisi_powerkey_down_hdl),
	&rasprobe_name(hisi_powerkey_up_hdl),
	&rasprobe_name(hisi_powerkey_1s_hdl),
	&rasprobe_name(hisi_powerkey_6s_hdl),
	&rasprobe_name(hisi_powerkey_8s_hdl),
	&rasprobe_name(hisi_powerkey_10s_hdl)
	#endif
};
