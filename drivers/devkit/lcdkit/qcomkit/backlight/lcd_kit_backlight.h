...
#define LCD_BACKLIGHT_UINIT_CMD_NUM 10
...
struct lcd_kit_backlight_info
{
	...
	struct backlight_ic_cmd uinit_cmds[LCD_BACKLIGHT_UINIT_CMD_NUM];
	unsigned int num_of_uinit_cmds;
	unsigned int uinit_vsp_index;
	unsigned int uinit_vsn_index;
