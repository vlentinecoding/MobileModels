...
if (($chip_plat ne "qcom") && ($chip_plat ne "hisi") && ($chip_plat ne "mtk") && ($chip_plat ne "sprd")){
...
{
    $plat_path = "$root_path/vendor/huawei/chipset_common/devkit/lcdkit/lcdkit3.0/config/sprd/$chip_name/lcdkit";
}
...
if ($chip_plat eq "sprd")
{
    $vender_list_path = "$root_path/vendor/huawei/chipset_common/devkit/lcdkit/lcdkit3.0/config/sprd/$chip_name";
}
...
if (($target_file_type eq "head") || ($target_file_type eq "dto-head") || ($target_file_type eq "all"))
{
	...
	my $lcd_kit_tools_patch = "/vendor/huawei/chipset_common/devkit/lcdkit/lcdkit3.0/tools";
...
if (($target_file_type eq "effect") && (($chip_plat eq 'hisi') || ($chip_plat eq 'mtk')))
{
