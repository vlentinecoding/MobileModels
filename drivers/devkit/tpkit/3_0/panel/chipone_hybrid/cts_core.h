...
enum cts_dev_hw_reg {
	...
	CTS_DEV_HW_REG_SRAM_STATUS = 0x4000cu,
};
...
enum cts_firmware_cmd {
	...
	CTS_CMD_FREQ_HOP_TO_0 = 0x38,
	CTS_CMD_FREQ_HOP_TO_1 = 0x39,
	CTS_CMD_FREQ_HOP_TO_2 = 0x3A,
	CTS_CMD_FREQ_HOP_TO_3 = 0x3B,
	CTS_CMD_FREQ_HOP_TO_4 = 0x3C,
...
struct chipone_ts_data {
	...
	bool test_sram;
	int sram_test_result;
	struct cts_sram_test_priv_param sram_test_priv_param;
	struct cts_test_param sram_test_param;
