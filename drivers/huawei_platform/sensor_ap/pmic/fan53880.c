...
#define LDO12_SEQ         0x0C
#define LDO34_SEQ         0x0D
#define LDO_ENABLE_BY_I2C 0x00
...
#define BUCK_SEQ                  0x0B
#define BUCK_ENABLE_BY_I2C        0x00
	...
	enum pmic_seq_index seq_index, u32 volt, int state)
{
	...
	i2c_func->i2c_write(i2c_client, BUCK_SEQ, BUCK_ENABLE_BY_I2C);
	hwlog_info("%s, set buck seq reg 0x%x, val 0x%x\n",
		__func__, BUCK_SEQ, BUCK_ENABLE_BY_I2C);
	...
	enum pmic_seq_index seq_index, u32 volt, int state)
{
	...
	i2c_func->i2c_read(i2c_client, chx_enable_reg, &chx_enable);
	i2c_func->i2c_write(i2c_client, LDO12_SEQ, LDO_ENABLE_BY_I2C);
	i2c_func->i2c_write(i2c_client, LDO34_SEQ, LDO_ENABLE_BY_I2C);
	hwlog_info("%s, set ldo12 seq reg 0x%x, val 0x%x, ldo34 seq reg 0x%x, val 0x%x\n",
		__func__, LDO12_SEQ, LDO_ENABLE_BY_I2C, LDO34_SEQ, LDO_ENABLE_BY_I2C);
