...
int hihonor_charger_glink_enable_hiz(int enable)
{
	...
	if (hihonor_oem_glink_oem_set_prop(CHARGER_OEM_SET_HIZ_EN, &enable, sizeof(enable))) {
...
int hihonor_charger_glink_enable_charge(int enable)
{
	...
	if (hihonor_oem_glink_oem_set_prop(CHARGER_OEM_SET_CHARGE_EN, &enable, sizeof(enable))) {
...
int hihonor_charger_glink_set_input_current(int input_current)
{
	...
	if (hihonor_oem_glink_oem_set_prop(CHARGER_OEM_SET_INPUT_CURRENT, &input_current, sizeof(input_current))) {
...
int hihonor_charger_glink_set_sdp_input_current(int input_current)
{
	...
	if (hihonor_oem_glink_oem_set_prop(CHARGER_OEM_SET_SDP_INPUT_CURRENT, &input_current, sizeof(input_current))) {
...
int hihonor_charger_glink_set_charge_current(int charge_current)
{
	...
	if (hihonor_oem_glink_oem_set_prop(CHARGER_OEM_SET_CHARGE_CURRENT, &charge_current, sizeof(charge_current))) {
