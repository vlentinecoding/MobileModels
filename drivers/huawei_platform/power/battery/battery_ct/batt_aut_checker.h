...
#define BATT_ACT_SIGN_OLD_ID "0x7500"
#define BATT_ACT_SIGN_ID "0x2000"
#define BATT_RETROFIT_SIGN_ID "0x7501"

struct batt_act_request {
	char act_key_id[BATT_MAX_KEY_ID_LEN];
	char act_key_old_id[BATT_MAX_KEY_ID_LEN];
...
struct batt_chk_rslt {
	...
	unsigned char oo_rematch; /* old battery old board rematch */
};
...
struct batt_chk_data {
	...
	struct work_struct act_write_work;
