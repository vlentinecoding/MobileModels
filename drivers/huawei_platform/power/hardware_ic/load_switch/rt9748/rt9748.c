...
static struct dc_ic_ops rt9748_sysinfo_ops = {
	.dev_name = "rt9748",
...
static struct dc_batinfo_ops rt9748_batinfo_ops = {
	.init = batinfo_init,
	...
	const struct i2c_device_id *id)
{
	...
	ret = dc_ic_ops_register(LVC_MODE, di->ic_role, &rt9748_sysinfo_ops);
	if (ret) {
