...
struct IMGSENSOR_HW_CFG imgsensor_chl_config[] = {
	{
		IMGSENSOR_SENSOR_IDX_MAIN,
		IMGSENSOR_I2C_DEV_0,
		{
...
struct IMGSENSOR_HW_CFG imgsensor_ntn_config[] = {
	{
		IMGSENSOR_SENSOR_IDX_MAIN,
		IMGSENSOR_I2C_DEV_0,
		{
...
struct IMGSENSOR_HW_CFG imgsensor_pkc_config[] = {
	{
		IMGSENSOR_SENSOR_IDX_MAIN,
		IMGSENSOR_I2C_DEV_0,
		{
...
struct IMGSENSOR_HW_CFG imgsensor_ang_config[] = {
	{
		IMGSENSOR_SENSOR_IDX_MAIN,
		IMGSENSOR_I2C_DEV_0,
		{
			{ IMGSENSOR_HW_PIN_MCLK,    IMGSENSOR_HW_ID_MCLK },
			{ IMGSENSOR_HW_PIN_VMCH, IMGSENSOR_HW_ID_REGULATOR },
			{ IMGSENSOR_HW_PIN_DVDD_EN, IMGSENSOR_HW_ID_GPIO },
			{ IMGSENSOR_HW_PIN_DOVDD,   IMGSENSOR_HW_ID_REGULATOR },
			{ IMGSENSOR_HW_PIN_RST,     IMGSENSOR_HW_ID_GPIO },
			{ IMGSENSOR_HW_PIN_NONE,    IMGSENSOR_HW_ID_NONE },
...
struct IMGSENSOR_HW_CFG imgsensor_jlh_config[] = {
	{
		IMGSENSOR_SENSOR_IDX_MAIN,
		IMGSENSOR_I2C_DEV_0,
		{
...
const product_custom_cfg_map g_product_cfg_map[] = {
	...
	{ "Chanel", &imgsensor_chl_config[0] },
	{ "ChanelV4", &imgsensor_chl_config[0] },
	{ "Ntn", &imgsensor_ntn_config[0] },
	{ "Ntn40m", &imgsensor_ntn_config[0] },
	{ "NtnV4", &imgsensor_ntn_config[0] },
	{ "Angela", &imgsensor_ang_config[0] },
	{ "Ntn40mV4", &imgsensor_ntn_config[0] },
	{ "Pkc", &imgsensor_pkc_config[0] },
	{ "ChanelV4Lite", &imgsensor_chl_config[0] },
	{ "Nto", &imgsensor_ntn_config[0] },
	{ "Julia", &imgsensor_jlh_config[0] },
};
