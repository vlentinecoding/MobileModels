...
#ifdef CONFIG_SUBSYS_CRASH_REASON_UPLOAD
#include <log/log_usertype.h>
#include "pil-q6v5-mss/pil_subsys_log.h"
#endif
...
#endif
#ifdef CONFIG_SUBSYS_CRASH_REASON_UPLOAD
	flag = get_logusertype_flag();
	if (flag == COMMERCIAL_USER || flag == OVERSEA_COMMERCIAL_USER ) {
		report_subsys_crash_log(name, reason, strlen(reason));
	}
#endif
}
...
#ifdef CONFIG_SUBSYS_CRASH_REASON_UPLOAD
	destroy_subsys_crash_log_queue();
#endif
