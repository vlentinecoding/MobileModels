...
#include "cx_dmd/soc_sleep_stats_dmd.h"
#endif
...
#ifdef CONFIG_HUAWEI_DSM
		cx_dmd_check_apss_state(apss_master_stats.accumulated_duration,
			apss_master_stats.last_entered, apss_master_stats.last_exited);
#endif
	}
