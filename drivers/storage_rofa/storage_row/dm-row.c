...
#ifndef CONFIG_HUAWEI_STORAGE_ROFA_FOR_MTK
	unsigned int bvec_off;
	sector_t sec_downrnd;

	bio->mas_bio.ci_key = base_bio->mas_bio.ci_key;
	bio->mas_bio.ci_key_len = base_bio->mas_bio.ci_key_len;
	bio->mas_bio.ci_key_index = base_bio->mas_bio.ci_key_index;
	bio->mas_bio.index = 0;

	if (base_bio->mas_bio.ci_key_len && base_bio->mas_bio.ci_key) {
		...
		bio->mas_bio.index = base_bio->mas_bio.index + bvec_off;
	}
#endif
#endif
}
