...
static int power_supply_raw_bat_set_property(struct power_supply *psy,
...
static int power_supply_raw_bat_is_writeable(struct power_supply *psy,
...
static const struct power_supply_desc power_supply_raw_battery_desc = {
	...
	.set_property = power_supply_raw_bat_set_property,
	.property_is_writeable = power_supply_raw_bat_is_writeable,
};
