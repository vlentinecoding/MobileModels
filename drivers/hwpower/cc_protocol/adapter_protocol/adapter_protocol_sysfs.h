/*
 * adapter_protocol_sysfs.h
 *
 * sysfs of adapter protocol driver
 *
...
#ifndef _ADAPTER_PROTOCOL_SYSFS_H_
#define _ADAPTER_PROTOCOL_SYSFS_H_
...
#endif /* _ADAPTER_PROTOCOL_SYSFS_H_ */
