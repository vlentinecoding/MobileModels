...
#include "cps4035_chip.h"

#define CPS4035_SW2TX_SLEEP_TIME              25 /* ms */
#define CPS4035_SW2TX_RETRY_TIME              500 /* ms */

#define CPS4035_SHUTDOWN_SLEEP_TIME           200
#define CPS4035_RCV_MSG_SLEEP_TIME            100
#define CPS4035_RCV_MSG_SLEEP_CNT             10
#define CPS4035_WAIT_FOR_ACK_SLEEP_TIME       50
#define CPS4035_WAIT_FOR_ACK_RETRY_CNT        10
#define CPS4035_SEND_MSG_RETRY_CNT            2
#define CPS4035_RX_TMP_BUFF_LEN               32

/* coil test */
#define CPS4035_COIL_TEST_PING_INTERVAL       0
#define CPS4035_COIL_TEST_PING_FREQ           115

struct cps4035_chip_info {
	u16 chip_id;
	u16 mtp_ver;
};

struct cps4035_global_val {
...
struct cps4035_tx_init_para {
	u16 ping_interval;
	u16 ping_freq;
};

struct cps4035_tx_fod_para {
	u16 ploss_th0;
	u16 ploss_th1;
	u16 ploss_th2;
	u16 ploss_th3;
...
struct cps4035_dev_info {
	struct i2c_client *client;
	struct device *dev;
	struct work_struct irq_work;
	struct delayed_work mtp_check_work;
	struct mutex mutex_irq;
	struct cps4035_global_val g_val;
	struct cps4035_tx_init_para tx_init_para;
	struct cps4035_tx_fod_para tx_fod;
	bool irq_active;
	int rx_ss_good_lth;
	int gpio_en;
...
enum cps4035_dev_hall_id {
	CPS4035_HALL_NULL_ID = 0,
	CPS4035_HALL_PEN_ID,
	CPS4035_HALL_KB_ID,
};
...
int cps4035_write_block(u16 reg, u8 *data, u8 data_len);
...
u8 *cps4035_get_die_id(void);
int cps4035_get_chip_info(struct cps4035_chip_info *info);
int cps4035_get_chip_info_str(char *info_str, int len);

/* cps4035 rx */
struct wireless_charge_device_ops *cps4035_get_rx_ops(void);
void cps4035_rx_mode_irq_handler(struct cps4035_dev_info *di);
void cps4035_rx_abnormal_irq_handler(struct cps4035_dev_info *di);
void cps4035_rx_shutdown_handler(void);
void cps4035_rx_probe_check_tx_exist(void);
int cps4035_rx_ops_register(void);
bool cps4035_rx_check_tx_exist(void);

/* cps4035 tx */
void cps4035_tx_mode_irq_handler(struct cps4035_dev_info *di);
struct wireless_tx_device_ops *cps4035_get_tx_ops(void);
...
/* cps4035 qi */
struct qi_protocol_ops *cps4035_get_qi_ops(void);
