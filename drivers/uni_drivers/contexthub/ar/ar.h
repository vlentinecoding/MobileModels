...
#ifndef	HUAWEI_HISMART_AR_H
#define	HUAWEI_HISMART_AR_H
...
#define HUAWEI_AR_DEBUG KERN_INFO
#define HUAWEI_AR_DEBUG_DUMP KERN_DEBUG
#define HUAWEI_AR_DEBUG_DUMP_OPT   if (0)print_hex_dump
//#define HUAWEI_AR_DATA_DEBUG
/*lint +e64*/
/*lint +e785*/
