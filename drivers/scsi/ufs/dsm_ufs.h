...
#define DSM_UFS_DEVICE_RESET_ERR        928008029
...
#define UFS_DEVICE_RESET_ERR        29
...
void uhshcd_rsp_sense_data(struct ufs_hba *hba, struct ufshcd_lrb *lrbp, int scsi_status);
...
void uhshcd_rsp_sense_data(struct ufs_hba *hba, struct ufshcd_lrb *lrbp, int scsi_status) {return 0;}
bool ufshcd_error_need_queue_work(struct ufs_hba *hba) {return;}
void ufshcd_error_linkup_check(struct ufs_hba *hba) {return 0; }
void ufshcd_error_timeout_check(struct ufs_hba *hba, 
				struct scsi_cmnd *scmd, int tag, bool found) {return 0; }
#define DSM_UFS_LOG(hba, no, fmt, a...)
#endif
#endif
