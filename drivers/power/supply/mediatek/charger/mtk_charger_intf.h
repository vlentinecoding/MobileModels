...
struct charger_custom_data {
	...
	int jeita_temp_t0_to_t1_iterm;
	int jeita_temp_t1_to_t2_iterm;
	int jeita_temp_t2_to_t3_iterm;
	int jeita_temp_t3_to_t4_iterm;
	int sdp_jeita_temp_above_t4_cv;
	int sdp_jeita_temp_t3_to_t4_cv;
	int sdp_jeita_temp_t2_to_t3_cv;
	int sdp_jeita_temp_t1_to_t2_cv;
	int sdp_jeita_temp_t0_to_t1_cv;
	int sdp_jeita_temp_below_t0_cv;
	int sdp_jeita_temp_t0_to_t1_iterm;
	int sdp_jeita_temp_t1_to_t2_iterm;
	int sdp_jeita_temp_t2_to_t3_iterm;
	int sdp_jeita_temp_t3_to_t4_iterm;
...
struct charger_manager {
	...
	/* is in clear cable_out_cnt status */
	bool clear_cable_out_cnt_status;
};
