...
#define UNIT_TRANS_100000 100000
...
/* cust req ocv data */
	...
	struct battery_rm bat_rm;
	int car_tune_default_value;
};
...
extern int battery_get_capacity(struct battery_data *data);
extern int battery_get_rm(struct battery_data *data);
