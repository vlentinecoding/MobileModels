...
#ifdef CONFIG_HW_VIP_THREAD
	rwsem_dynamic_vip_enqueue(current, waiter.task, rwsem_owner_with_flag(sem), sem);
#endif
...
#ifdef CONFIG_HW_VIP_THREAD
	rwsem_dynamic_vip_enqueue(waiter.task, current, rwsem_owner_with_flag(sem), sem);
#endif
#ifdef CONFIG_HW_QOS_THREAD
	rwsem_dynamic_qos_enqueue(rwsem_owner_with_flag(sem), waiter.task);
#endif
