...
#define LB_HW_VIP	(0x100  << LB_POLICY_SHIFT)
#define LB_HW_VIP_OPT	(0x101  << LB_POLICY_SHIFT)
#define LB_HW_RTG	(0x102  << LB_POLICY_SHIFT)
#define LB_HW_BOOST	(0x104  << LB_POLICY_SHIFT)
#define LB_VIP_PREFER_BIG      (0x108  << LB_POLICY_SHIFT)
