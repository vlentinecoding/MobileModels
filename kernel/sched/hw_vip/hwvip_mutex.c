...
#include <linux/sched/hw_vip/hwvip_mutex.h>
...
#if LINUX_VERSION_CODE >= KERNEL_VERSION(4, 19, 0)
	waiter = container_of(entry, struct mutex_waiter, list);
...
static inline struct task_struct *get_mutex_owner(struct mutex *lock)
{
