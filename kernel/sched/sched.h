...
#ifndef  _LINUX_SCHED_SCHED_H_
#define  _LINUX_SCHED_SCHED_H_
...
#ifdef CONFIG_SCHED_TASK_UTIL_CLAMP
static inline unsigned int get_min_util(struct rq *rq)
{
	return rq->uclamp[UCLAMP_MIN].value;
}
#endif
...
struct rtg_class {
	void (*sched_update_rtg_tick)(struct walt_related_thread_group *grp);
};
