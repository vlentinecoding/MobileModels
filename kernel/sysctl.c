...
#include <linux/sched/hw_rtg/rtg_pseudo.h>
#endif
...
#endif
#if defined(CONFIG_DIRECT_SWAPPINESS)
...
#ifdef CONFIG_HW_RTG_PSEUDO_TICK
	{
		.procname	= "sched_enable_frame_pseudo",
		.data		= &sysctl_sched_enable_frame_pseudo,
		.maxlen		= sizeof(unsigned int),
		.mode		= 0644,
		.proc_handler	= sched_proc_frame_pseudo_handler,
		.extra1		= &zero,
		.extra2		= &two,
	},
#endif
