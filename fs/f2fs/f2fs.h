...
static inline void f2fs_lock_op(struct f2fs_sb_info *sbi)
{
	...
	if (sbi->cp_rwsem_owner &&
		...
		if (sbi->cp_rwsem_owner) {
			...
			printk(KERN_ERR "last_arrival is %llu, last_queued is %llu\n",
...
#define F2FS_UNRM_VIDEO_FL		0x01000000
#define FS_UNRM_VIDEO_FL		F2FS_UNRM_VIDEO_FL

#define F2FS_UNRM_DMD_PHOTO_FL		0x02000000
#define FS_UNRM_DMD_PHOTO_FL		F2FS_UNRM_DMD_PHOTO_FL

#define F2FS_UNRM_DMD_VIDEO_FL		0x04000000
#define FS_UNRM_DMD_VIDEO_FL		F2FS_UNRM_DMD_VIDEO_FL
