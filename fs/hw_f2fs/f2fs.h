...
#define F2FS_MOUNT_INLINE_ENCRYPT	0x40000000
...
/* User visible flags */
#define F2FS_FL_USER_VISIBLE		(0x30CBDFFF | F2FS_UNRM_ACM_FLMASK)
/* User modifiable flags */
#define F2FS_FL_USER_MODIFIABLE		(0x204BC0FF | F2FS_UNRM_ACM_FLMASK)
...
#define stat_dec_bggc_count(sbi)        ((sbi)->bg_gc--)
...
#ifdef CONFIG_FS_UNI_ENCRYPTION
	if(f2fs_encrypted_file(inode) && f2fs_inline_encrypted_inode(inode))
		return false;
#endif
