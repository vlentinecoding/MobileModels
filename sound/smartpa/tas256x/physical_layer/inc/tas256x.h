...
#include "drv2634.h"
#endif //CONFIG_TAS26XX_HAPTICS

#define TAS256X_DRIVER_TAG  "TAS256X_REL_010403"
#define TAS2562_CODEC "tas2562-codec"
...
/* Added for TX Config Update Bits in Group */
#define TAS256X_TDMCONFIGURATIONREG4_TXCONFIG_MASK (0xf << 4)
#define TAS256X_TDMCONFIGURATIONREG4_TXCONFIG_SHIFT (4)
...
#define TAS256X_INTERRUPTCONFIGURATION_CLK_ERR_PWR_EN_MASK (0x1 << 7)
#define TAS256X_INTERRUPTCONFIGURATION_CLK_ERR_PWR_EN (0x1 << 7)
#define TAS256X_INTERRUPTCONFIGURATION_CLK_ERR_PWR_DIS (0x0 << 7)
...
#define TAS256X_CLOCK_HALT_TIMER_SHIFT	(3)
...
#define TAS256X_INTERNAL_STATUS	TAS256X_REG(0x0, 0x0, 0x78)
...
#define TAS256X_IRQ_DET_TIMEOUT		30000
#define TAS256X_IRQ_DET_CNT_LIMIT		3
...
/* REGBIN related */
#define TAS256X_CONFIG_SIZEV102	    (10)
#define TAS256X_CONFIG_SIZE	(64)
...
struct tas_device {
	...
	struct delayed_work pwrup_work;
	unsigned int pwrup_delay;
	int dvc_pcm_bk;
};
