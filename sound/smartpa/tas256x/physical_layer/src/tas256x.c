...
#if IS_ENABLED(CONFIG_TAS26XX_HAPTICS)
static unsigned int p_drv2634_classh_d_data[] = {
	TAS2562_TDMCONFIGURATIONREG8, 0x1, 0x05,
	TAS2562_TDMCONFIGURATIONREG9, 0x1, 0x06,
	DRV2634_TDMCONFIGURATIONREG10, 0x1, 0x07,
	DRV2634_TDMCONFIGURATIONREG7, 0x1, 0x4,
	TAS256X_POWERCONTROL, 0x1, 0x0a,
};
#endif
 ...
 *
 * Formula:
 *	DEC2HEX(ROUND(((10^(Noise Level in dB/20))*(2^31)),0))
 */
static char icn_thr[85][4] = {
	{0x00, 0x20, 0xC4, 0x9C}, {0x00, 0x1D, 0x34, 0x5B}, {0x00, 0x1A, 0x07, 0x4F},
	{0x00, 0x17, 0x32, 0xAE}, {0x00, 0x14, 0xAC, 0xDB}, {0x00, 0x12, 0x6D, 0x43},
	{0x00, 0x10, 0x6C, 0x43}, {0x00, 0x0E, 0xA3, 0x0E}, {0x00, 0x0D, 0x0B, 0x91},
	{0x00, 0x0B, 0xA0, 0x64}, {0x00, 0x0A, 0x5C, 0xB6}, {0x00, 0x09, 0x3C, 0x3B},
	{0x00, 0x08, 0x3B, 0x20}, {0x00, 0x07, 0x55, 0xFA}, {0x00, 0x06, 0x89, 0xBF},
	{0x00, 0x05, 0xD3, 0xBB}, {0x00, 0x05, 0x31, 0x81}, {0x00, 0x04, 0xA0, 0xEC},
	{0x00, 0x04, 0x20, 0x10}, {0x00, 0x03, 0xAD, 0x38}, {0x00, 0x03, 0x46, 0xDC},
	{0x00, 0x02, 0xEB, 0xA3}, {0x00, 0x02, 0x9A, 0x55}, {0x00, 0x02, 0x51, 0xDE},
	{0x00, 0x02, 0x11, 0x49}, {0x00, 0x01, 0xD7, 0xBA}, {0x00, 0x01, 0xA4, 0x6D},
	{0x00, 0x01, 0x76, 0xB5}, {0x00, 0x01, 0x4D, 0xF5}, {0x00, 0x01, 0x29, 0xA4},
	{0x00, 0x01, 0x09, 0x45}, {0x00, 0x00, 0xEC, 0x6C}, {0x00, 0x00, 0xD2, 0xB6},
	{0x00, 0x00, 0xBB, 0xCC}, {0x00, 0x00, 0xA7, 0x60}, {0x00, 0x00, 0x95, 0x2C},
	{0x00, 0x00, 0x84, 0xF3}, {0x00, 0x00, 0x76, 0x7E}, {0x00, 0x00, 0x69, 0x9B},
	{0x00, 0x00, 0x5E, 0x1F}, {0x00, 0x00, 0x53, 0xE3}, {0x00, 0x00, 0x4A, 0xC3},
	{0x00, 0x00, 0x42, 0xA2}, {0x00, 0x00, 0x3B, 0x63}, {0x00, 0x00, 0x34, 0xEE},
	{0x00, 0x00, 0x2F, 0x2C}, {0x00, 0x00, 0x2A, 0x0B}, {0x00, 0x00, 0x25, 0x78},
	{0x00, 0x00, 0x21, 0x65}, {0x00, 0x00, 0x1D, 0xC4}, {0x00, 0x00, 0x1A, 0x87},
	{0x00, 0x00, 0x17, 0xA4}, {0x00, 0x00, 0x15, 0x12}, {0x00, 0x00, 0x12, 0xC8},
	{0x00, 0x00, 0x10, 0xBD}, {0x00, 0x00, 0x0E, 0xEB}, {0x00, 0x00, 0x0D, 0x4C},
	{0x00, 0x00, 0x0B, 0xD9}, {0x00, 0x00, 0x0A, 0x90}, {0x00, 0x00, 0x09, 0x6A},
	{0x00, 0x00, 0x08, 0x63}, {0x00, 0x00, 0x07, 0x7A}, {0x00, 0x00, 0x06, 0xAA},
	{0x00, 0x00, 0x05, 0xF0}, {0x00, 0x00, 0x05, 0x4B}, {0x00, 0x00, 0x04, 0xB8},
	{0x00, 0x00, 0x04, 0x34}, {0x00, 0x00, 0x03, 0xBF}, {0x00, 0x00, 0x03, 0x57},
	{0x00, 0x00, 0x02, 0xFA}, {0x00, 0x00, 0x02, 0xA7}, {0x00, 0x00, 0x02, 0x5D},
	{0x00, 0x00, 0x02, 0x1B}, {0x00, 0x00, 0x01, 0xE1}, {0x00, 0x00, 0x01, 0xAC},
	{0x00, 0x00, 0x01, 0x7E}, {0x00, 0x00, 0x01, 0x54}, {0x00, 0x00, 0x01, 0x2F},
	{0x00, 0x00, 0x01, 0x0E}, {0x00, 0x00, 0x00, 0xF1}, {0x00, 0x00, 0x00, 0xD7},
	{0x00, 0x00, 0x00, 0xBF}, {0x00, 0x00, 0x00, 0xAB}, {0x00, 0x00, 0x00, 0x98},
	{0x00, 0x00, 0x00, 0x87}
};
 ...
 *
 * Formula :
 * value = ((time in ms)/1000) * sample_rate
 */
static char icn_hyst_48kHz[20][4] = {
	{0x00, 0x00, 0x12, 0xC0}, {0x00, 0x00, 0x25, 0x80}, {0x00, 0x00, 0x38, 0x40},
	{0x00, 0x00, 0x4B, 0x00}, {0x00, 0x00, 0x5D, 0xC0}, {0x00, 0x00, 0x70, 0x80},
	{0x00, 0x00, 0x83, 0x40}, {0x00, 0x00, 0x96, 0x00}, {0x00, 0x00, 0xA8, 0xC0},
	{0x00, 0x00, 0xBB, 0x80}, {0x00, 0x00, 0xCE, 0x40}, {0x00, 0x00, 0xE1, 0x00},
	{0x00, 0x00, 0xF3, 0xC0}, {0x00, 0x01, 0x06, 0x80}, {0x00, 0x01, 0x19, 0x40},
	{0x00, 0x01, 0x2C, 0x00}, {0x00, 0x01, 0x3E, 0xC0}, {0x00, 0x01, 0x51, 0x80},
	{0x00, 0x01, 0x64, 0x40}, {0x00, 0x01, 0x77, 0x00}
};

static char icn_hyst_96kHz[20][4] = {
	{0x00, 0x00, 0x25, 0x80}, {0x00, 0x00, 0x4B, 0x00}, {0x00, 0x00, 0x70, 0x80},
	{0x00, 0x00, 0x96, 0x00}, {0x00, 0x00, 0xBB, 0x80}, {0x00, 0x00, 0xE1, 0x00},
	{0x00, 0x01, 0x06, 0x80}, {0x00, 0x01, 0x2C, 0x00}, {0x00, 0x01, 0x51, 0x80},
	{0x00, 0x01, 0x77, 0x00}, {0x00, 0x01, 0x9C, 0x80}, {0x00, 0x01, 0xC2, 0x00},
	{0x00, 0x01, 0xE7, 0x80}, {0x00, 0x02, 0x0D, 0x00}, {0x00, 0x02, 0x32, 0x80},
	{0x00, 0x02, 0x58, 0x00}, {0x00, 0x02, 0x7D, 0x80}, {0x00, 0x02, 0xA3, 0x00},
	{0x00, 0x02, 0xC8, 0x80}, {0x00, 0x02, 0xEE, 0x00}
};
		...
		if (n_register == TAS256X_MSLEEP) {
			...
			if (n_register != 0xFFFFFFFF) {
				...
				if (n_size > 1) {
					...
					ret = p_tas256x->bulk_write(
						p_tas256x, chn,
						n_register, buf, n_size);
					if (ret < 0)
						break;
				} else if (n_size == 1) {
					ret = p_tas256x->write(p_tas256x,
					chn,
					n_register, n_data[0]);
					if (ret < 0)
						break;
...
int tas256x_update_default_params(struct tas256x_priv *p_tas256x, int chn)
{
	int ret = -1;

	/*Initialize to default values*/
	if (p_tas256x->devs[chn-1]->device_id == DEVICE_TAS2562) {
		p_tas256x->devs[chn-1]->dvc_pcm = 55; /*0dB*/
		p_tas256x->devs[chn-1]->lim_max_attn = 7; /*-9dB*/
		p_tas256x->devs[chn-1]->lim_thr_max = 13; /*9V*/
		p_tas256x->devs[chn-1]->lim_thr_min = 3; /*4V*/
		p_tas256x->devs[chn-1]->lim_infl_pt = 13; /*3.3V*/
		p_tas256x->devs[chn-1]->lim_trk_slp = 0; /*1 V/V*/
		p_tas256x->devs[chn-1]->bop_thd = 4; /*2.9 V*/
		p_tas256x->devs[chn-1]->bosd_thd = 2; /*2.7 V*/
		p_tas256x->devs[chn-1]->bst_vltg = 0xA; /*Mode = speaker*/
		p_tas256x->devs[chn-1]->bst_ilm = 0x36; /*0dB*/
		p_tas256x->devs[chn-1]->ampoutput_lvl = 0x10; /*15.5dBV: 8 + 0.5 * ampoutput_lvl */
		p_tas256x->devs[chn-1]->lim_switch = 0; /*-9dB*/
		p_tas256x->devs[chn-1]->lim_att_rate = 1; /*9V*/
		p_tas256x->devs[chn-1]->lim_att_stp_size = 1; /*4V*/
		p_tas256x->devs[chn-1]->lim_rel_rate = 6; /*3.3V*/
		p_tas256x->devs[chn-1]->lim_rel_stp_size = 1; /*1 V/V*/
		p_tas256x->devs[chn-1]->bop_enable = 1; /*2.9 V*/
		p_tas256x->devs[chn-1]->bop_mute = 0; /*2.7 V*/
		p_tas256x->devs[chn-1]->bosd_enable = 0; /*3.3V*/
		p_tas256x->devs[chn-1]->bop_att_rate = 1; /*1 V/V*/
		p_tas256x->devs[chn-1]->bop_att_stp_size = 1; /*2.9 V*/
		p_tas256x->devs[chn-1]->bop_hld_time = 6; /*2.7 V*/
		p_tas256x->devs[chn-1]->vbat_lpf = 2; /*2.7 V*/
		p_tas256x->devs[chn-1]->rx_cfg = 0;
		p_tas256x->devs[chn-1]->classh_timer = 5;
		p_tas256x->devs[chn-1]->reciever_enable = 0;
		p_tas256x->devs[chn-1]->icn_thr = 45;
		p_tas256x->devs[chn-1]->icn_hyst = 19;
		p_tas256x->devs[chn-1]->icn_sw = 1;
		p_tas256x->devs[chn-1]->pwrup_delay = 0;
	} else if (p_tas256x->devs[chn-1]->device_id == DEVICE_TAS2564) {
		p_tas256x->devs[chn-1]->rx_mode = 0; /*Mode = speaker*/
		p_tas256x->devs[chn-1]->dvc_pcm = 55; /*0dB*/
		p_tas256x->devs[chn-1]->lim_max_attn = 7; /*-9dB*/
		p_tas256x->devs[chn-1]->lim_thr_max = 13; /*9V*/
		p_tas256x->devs[chn-1]->lim_thr_min = 3; /*4V*/
		...
		p_tas256x->devs[chn-1]->bop_thd = 4; /*2.9 V*/
		p_tas256x->devs[chn-1]->bosd_thd = 2; /*2.7 V*/
		p_tas256x->devs[chn-1]->bst_vltg = 13; /*Mode = speaker*/
		p_tas256x->devs[chn-1]->bst_ilm = 0x39; /*0dB*/
		p_tas256x->devs[chn-1]->ampoutput_lvl = 0xD; /*16dBV: 9.5 + 0.5 * ampoutput_lvl */
		p_tas256x->devs[chn-1]->lim_switch = 0; /*-9dB*/
		p_tas256x->devs[chn-1]->lim_att_rate = 1; /*9V*/
		p_tas256x->devs[chn-1]->lim_att_stp_size = 1; /*4V*/
		p_tas256x->devs[chn-1]->lim_rel_rate = 6; /*3.3V*/
	...
	p_tas256x->mn_sampling_rate = 48000;
	...
	enum channel chn)
{
	...
	ret = p_tas256x->update_bits(p_tas256x,
	...
	ret |= p_tas256x->update_bits(p_tas256x, chn,
		TAS256X_MISC_CLASSD,
...
int tas256x_power_check(struct tas256x_priv *p_tas256x, int *state, int chn)
{
	int ret = -1;
	int status1 = 0, status2 = 0;

	ret = p_tas256x->read(p_tas256x, chn,
		TAS256X_POWERCONTROL, &status1);

	ret = p_tas256x->read(p_tas256x, chn,
		TAS256X_INTERNAL_STATUS, &status2);

	if (ret == 0) {
		status1 &= TAS256X_POWERCONTROL_OPERATIONALMODE10_MASK;
	
		if ((status1 != TAS256X_POWERCONTROL_OPERATIONALMODE10_SHUTDOWN)
			&& (status1 != TAS256X_POWERCONTROL_OPERATIONALMODE10_MUTE)
			&& (status2 == 0xcf))
			*state = 1;
		else
			*state = 0;
...
bool tas256x_iv_sense_enable_get(struct tas256x_priv *p_tas256x, int chn)
{
	int ret = -1;
	bool enable = 0;
	int value = 0;
	...
	if (ret < 0) { /*TODO: Fix the return value*/
...
int tas256x_set_iv_slot(struct tas256x_priv *p_tas256x, int chn, int vslot,
	int islot)
{
	int ret = -1;
	...
	ret = p_tas256x->write(p_tas256x, chn,
...
int tas256x_set_vbat_slot(struct tas256x_priv *p_tas256x, int chn, int slot)
{
	int ret = -1;
...
int tas256x_rx_set_start_slot(struct tas256x_priv *p_tas256x,
	unsigned int rx_start_slot, int chn)
{
	int ret = -1;
...
int tas256x_tx_set_start_slot(struct tas256x_priv *p_tas256x,
	unsigned int tx_start_slot, int chn)
{
	int ret = -1;
...
int tas256x_rx_set_frame_start(struct tas256x_priv *p_tas256x,
	unsigned int frame_start, int chn)
{
	int ret = -1;
...
int tas256x_interrupt_clear(struct tas256x_priv *p_tas256x, int chn)
{
	int ret = -1;
...
int tas256x_icn_disable(struct tas256x_priv *p_tas256x, int disable, int chn)
{
	int ret = -1;
	...
	if (ret == 0)
		p_tas256x->devs[chn-1]->icn_sw = disable;

	return ret;
}

/*Todo: Add more details. Improve ICN Config*/
int tas256x_icn_config(struct tas256x_priv *p_tas256x, int value, int chn)
{
	int ret = -1;
...
int tas256x_set_misc_config(struct tas256x_priv *p_tas256x, int value, int chn)
{
	int ret = -1;
...
int tas256x_device_retry(struct tas256x_priv *p_tas256x, int value, int chn)
{
	int ret = -1;
	...
	if (value) { /* Enable */
		...
		/* TDM Clock Error Retry */
		ret = p_tas256x->update_bits(p_tas256x, chn,
			TAS256X_INTERRUPTCONFIGURATION,
			TAS256X_INTERRUPTCONFIGURATION_CLK_ERR_PWR_EN_MASK,
			TAS256X_INTERRUPTCONFIGURATION_CLK_ERR_PWR_EN);
	} else { /* Disable */
		/* Over Current Retry */
		ret = p_tas256x->update_bits(p_tas256x, chn,
			TAS256X_MISCCONFIGURATIONREG0,
		...
		ret = p_tas256x->update_bits(p_tas256x, chn,
			TAS256X_INTERRUPTCONFIGURATION,
			TAS256X_INTERRUPTCONFIGURATION_CLK_ERR_PWR_EN_MASK,
			TAS256X_INTERRUPTCONFIGURATION_CLK_ERR_PWR_DIS);			
	}

	return ret;
}

/* Updated to support only TX Configs and
 * not touching TDM/Interface Settings as it will be done by DT Settings
 * or Machine dai_fmt
 */
int tas256x_set_tx_config(struct tas256x_priv *p_tas256x, int value, int chn)
{
	int ret = -1;

	if (chn == channel_both) {
		if (p_tas256x->devs[channel_left -1]->dac_power == 1) {
		ret = p_tas256x->update_bits(p_tas256x, channel_left,
				TAS256X_TDMConfigurationReg4,
				TAS256X_TDMCONFIGURATIONREG4_TXCONFIG_MASK,
				0xf << (TAS256X_TDMCONFIGURATIONREG4_TXCONFIG_SHIFT));
		if (ret < 0)
			return ret;
		}
		if (p_tas256x->devs[channel_right -1]->dac_power == 1) {
		ret = p_tas256x->update_bits(p_tas256x, channel_right,
				TAS256X_TDMConfigurationReg4,
				TAS256X_TDMCONFIGURATIONREG4_TXCONFIG_MASK,
				0x1 << (TAS256X_TDMCONFIGURATIONREG4_TXCONFIG_SHIFT));
		if (ret < 0)
			return ret;
		}
	} else {
		ret = p_tas256x->update_bits(p_tas256x, chn,
				TAS256X_TDMConfigurationReg4,
				TAS256X_TDMCONFIGURATIONREG4_TXCONFIG_MASK,
				0x0 << (TAS256X_TDMCONFIGURATIONREG4_TXCONFIG_SHIFT));
		if (ret < 0)
			return ret;
	}
...
int tas256x_set_clock_config(struct tas256x_priv *p_tas256x, int value, int chn)
{
	int ret = -1;
 ...
 * 7 - 838ms
 */
int tas256x_update_clk_halt_timer(struct tas256x_priv *p_tas256x, int value, int chn)
{
	int ret = -1;
	...
	ret = p_tas256x->update_bits(p_tas256x, chn,
				...
				value << (TAS256X_CLOCK_HALT_TIMER_SHIFT));
	...
	int chn)
{
	...
	ret = tas256x_i2c_load_data(p_tas256x, chn,
			p_tas256x_classh_d_data);
#if IS_ENABLED(CONFIG_TAS26XX_HAPTICS)
	if (p_tas256x->mn_haptics) {
		if ((p_tas256x->mn_channels == 2) && (chn & channel_right)) {
			ret = tas256x_i2c_load_data(p_tas256x, channel_right,
					p_drv2634_classh_d_data);
		}
	}
#endif
	return ret;
...
int tas256x_HPF_FF_Bypass(struct tas256x_priv *p_tas256x, int value, int chn)
{
	int ret = -1;
...
int tas256x_HPF_FB_Bypass(struct tas256x_priv *p_tas256x, int value, int chn)
{
	int ret = -1;

#if IS_ENABLED(CONFIG_TAS26XX_HAPTICS)
	if (!p_tas256x->mn_haptics) {
		ret = p_tas256x->bulk_write(p_tas256x, chn,
				TAS256X_HPF, HPF_reverse_path,
				ARRAY_SIZE(HPF_reverse_path));
	} else {
		if (chn & channel_left) {
			ret = p_tas256x->bulk_write(p_tas256x, channel_left,
					TAS256X_HPF, HPF_reverse_path,
					ARRAY_SIZE(HPF_reverse_path));
			
		} else if ((p_tas256x->mn_channels == 2) && (chn & channel_right)) {

			ret = p_tas256x->bulk_write(p_tas256x, channel_right,
					TAS256X_HPF, DRV2634_HPF_reverse_path1,
					ARRAY_SIZE(DRV2634_HPF_reverse_path1));
			ret = p_tas256x->bulk_write(p_tas256x, channel_right,
					DRV2634_IVHPFC_CFG5, DRV2634_HPF_reverse_path2,
					ARRAY_SIZE(DRV2634_HPF_reverse_path2));
			ret = p_tas256x->bulk_write(p_tas256x, channel_right,
					DRV2634_IVHPFC_CFG9, DRV2634_HPF_reverse_path3,
					ARRAY_SIZE(DRV2634_HPF_reverse_path3));
			ret = p_tas256x->bulk_write(p_tas256x, channel_right,
					DRV2634_1C, DRV2634_HPF_reverse_path4,
					ARRAY_SIZE(DRV2634_HPF_reverse_path4));
		}
	}
#else
	ret = p_tas256x->bulk_write(p_tas256x, chn,
...
int tas56x_software_reset(struct tas256x_priv *p_tas256x, int chn)
{
	int ret = -1;

	ret = p_tas256x->write(p_tas256x, chn, TAS256X_SOFTWARERESET,
...
int tas256x_interrupt_determine(struct tas256x_priv *p_tas256x, int chn,
...
int tas56x_get_chipid(struct tas256x_priv *p_tas256x, int *chipid, int chn)
{
	int ret = -1;
...
int tas2564_rx_mode_update(struct tas256x_priv *p_tas256x, int rx_mode, int chn)
{
	int ret = -1;

	if (rx_mode)
		ret = p_tas256x->update_bits(p_tas256x,
			chn, TAS2564_PLAYBACKCONFIGURATIONREG0,
	...
	if (ret == 0)
		p_tas256x->devs[chn-1]->rx_mode = rx_mode;
	...
	int value, int chn)
{
	...
	if ((value >= 0) && (value < 57)) {
		...
		if (ret == 0)
			p_tas256x->devs[chn-1]->dvc_pcm = value;
	}
	...
	int value, int chn)
{
	...
	if ((value >= 0) && (value < 16)) {
		...
		if (ret == 0)
			p_tas256x->devs[chn-1]->lim_max_attn = value;
	}
	...
	int value, int chn)
{
	...
	if ((value >= 0) && (value < 27)) {
		...
		if (ret == 0)
			p_tas256x->devs[chn-1]->lim_thr_max = value;
	}
	...
	int value, int chn)
{
	...
	if ((value >= 0) && (value < 27)) {
		...
		if (ret == 0)
			p_tas256x->devs[chn-1]->lim_thr_min = value;
	}
	...
	int value, int chn)
{
	...
	if ((value >= 0) && (value < 41)) {
		...
		if (ret == 0)
			p_tas256x->devs[chn-1]->lim_infl_pt = value;
	}
	...
	int value, int chn)
{
	...
	if ((value >= 0) && (value < 7)) {
		...
		if (ret == 0)
			p_tas256x->devs[chn-1]->lim_trk_slp = value;
	}
	...
	int value, int chn)
{
	...
	if ((value >= 0) && (value < 16)) {
		...
		if (ret == 0)
			p_tas256x->devs[chn-1]->bop_thd = value;
	}
	return ret;
}
	...
	int value, int chn)
{
	...
	if ((value >= 0) && (value < 16)) {
		...
		if (ret == 0)
			p_tas256x->devs[chn-1]->bosd_thd = value;
	}
	...
	int value, int chn)
{
	...
	/* Fixed upper/lower limits issue*/
	if ((value >= 0) && (value <= 0x1C)) {
		if (p_tas256x->devs[chn-1]->device_id == DEVICE_TAS2562) {
			ret = p_tas256x->update_bits(p_tas256x,
				chn, TAS2562_PLAYBACKCONFIGURATIONREG0,
				TAS2562_PLAYBACKCONFIGURATIONREG0_AMPLIFIERLEVEL51_MASK,
				value << TAS2562_PLAYBACKCONFIGURATIONREG0_AMPLIFIERLEVEL51_SHIFT);
		} else if (p_tas256x->devs[chn-1]->device_id == DEVICE_TAS2564) {
			ret = p_tas256x->update_bits(p_tas256x,
				chn, TAS2564_PLAYBACKCONFIGURATIONREG0,
				TAS2564_PLAYBACKCONFIGURATIONREG0_AMPLIFIERLEVEL51_MASK,
				value << TAS2564_PLAYBACKCONFIGURATIONREG0_AMPLIFIERLEVEL51_SHIFT);
		}
	}

	if (ret == 0)
		p_tas256x->devs[chn-1]->ampoutput_lvl = value;
	...
	int value, int chn)
{
	...
	if ((value >= 0) && (value < 2))
		ret = p_tas256x->update_bits(p_tas256x,
			chn, TAS256X_LIMITERCONFIGURATION0,
			TAS256X_LIMITER_ENABLE_MASK,
			(value) << TAS256X_LIMITER_ENABLE_SHIFT);

	if (ret == 0)
		p_tas256x->devs[chn-1]->lim_switch = value;
	...
	int value, int chn)
{
	...
	if (ret == 0)
		p_tas256x->devs[chn-1]->lim_att_rate = value;
	...
	int value, int chn)
{
	...
	if (ret == 0)
		p_tas256x->devs[chn-1]->lim_att_stp_size = value;
	...
	int value, int chn)
{
	...
	if ((value >= 0) && (value < 8))
		ret = p_tas256x->update_bits(p_tas256x,
			chn, TAS256X_LIMITERCONFIGURATION1,
			TAS256X_LIMITER_RELEASERATE_MASK,
			(value) << TAS256X_LIMITER_RELEASERATE_SHIFT);

	if (ret == 0)
		p_tas256x->devs[chn-1]->lim_rel_rate = value;
	...
	int value, int chn)
{
	...
	if (ret == 0)
		p_tas256x->devs[chn-1]->lim_rel_stp_size = value;
	...
	int chn)
{
	...
	if ((value >= 0) && (value < 2))
		ret = p_tas256x->update_bits(p_tas256x,
			chn, TAS256X_BOPCONFIGURATION0,
			TAS256X_BOP_ENABLE_MASK,
			(value) << TAS256X_BOP_ENABLE_SHIFT);

	if (ret == 0)
		p_tas256x->devs[chn-1]->bop_enable = value;
	...
	int chn)
{
	...
	if (ret == 0)
		p_tas256x->devs[chn-1]->bop_mute = value;
	...
	int value, int chn)
{
	...
	if (ret == 0)
		p_tas256x->devs[chn-1]->bosd_enable = value;
	...
	int value, int chn)
{
	...
	if ((value >= 0) && (value < 8))
		ret = p_tas256x->update_bits(p_tas256x,
			chn, TAS256X_BOPCONFIGURATION1,
			TAS256X_BOP_ATTACKRATE_MASK,
			(value) << TAS256X_BOP_ATTACKRATE_SHIFT);

	if (ret == 0)
		p_tas256x->devs[chn-1]->bop_att_rate = value;
	...
	int value, int chn)
{
	...
	if (ret == 0)
		p_tas256x->devs[chn-1]->bop_att_stp_size = value;
	...
	int chn)
{
	...
	if (ret == 0)
		p_tas256x->devs[chn-1]->bop_hld_time = value;

	return ret;
}

int tas256x_update_vbat_lpf(struct tas256x_priv *p_tas256x, int value, int chn)
{
	int ret = -1;

	if ((value >= 0) && (value < 4)) {
		ret = p_tas256x->update_bits(p_tas256x,
			chn, TAS256X_VBATFILTER,
			TAS256X_VBAT_LPF_MASK,
			(value) << TAS256X_VBAT_LPF_SHIFT);
		if (ret == 0)
			p_tas256x->devs[chn-1]->vbat_lpf = value;
	}

	return ret;
}

int tas256x_update_rx_cfg(struct tas256x_priv *p_tas256x, int value, int chn)
{
	int ret = -1;
	int data = -1;
	...
	if (ret == 0)
		p_tas256x->devs[chn-1]->rx_cfg = value;
	...
	int chn)
{
	...
	if (p_tas256x->devs[chn-1]->device_id == DEVICE_TAS2564) {
		ret =
			p_tas256x->write(p_tas256x, chn, TAS2564_CLASSH_SLOPE,
			classH_slope[value]);
	}
	...
	if (ret == 0)
		p_tas256x->devs[chn-1]->classh_timer = value;
	...
	int chn)
{
	...
	if (enable) {
		/*Unlock test page*/
		ret =
			p_tas256x->write(p_tas256x, chn, TAS256X_TEST_PAGE_LOCK,
				0xd);
		/*Keep DAC modulator dither to minimum*/
		ret |=
			p_tas256x->write(p_tas256x, chn, TAS256X_DAC_MODULATOR,
				0xc0);
		/*Force DAC unmute*/
		ret |=
			p_tas256x->write(p_tas256x, chn, TAS256X_DAC_MUTE,
				0x04);
		/*Force the device in idle channel mode*/
		ret |=
			p_tas256x->write(p_tas256x, chn, TAS256X_ICN_MODE,
				0x14);
		/* ICN improvement*/
		ret |=
			p_tas256x->write(p_tas256x, chn, TAS256X_ICN_IMPROVE,
				0x1f);
		...
		ret |=
			p_tas256x->write(p_tas256x, chn, TAS256X_ICN_SW_REG,
				0x02);
	} else {
		/*Unlock test page*/
		ret =
		...
		ret |= p_tas256x->update_bits(p_tas256x, chn,
			...
			0x00);
		ret |=
			tas256x_icn_disable(p_tas256x,
				p_tas256x->devs[chn-1]->icn_sw, chn);
	}

	if (ret == 0)
		p_tas256x->devs[chn-1]->reciever_enable = enable;

	return ret;
}

int tas256x_enable_emphasis_filter(struct tas256x_priv *p_tas256x, int chn,
	int samplerate)
{
	int ret = -1;
	int i = 0;
	...
	if (chn == channel_both) {
		for (i = 0; i < p_tas256x->mn_channels; i++) {
			if ((p_tas256x->devs[i]->device_id == DEVICE_TAS2562)
				&& (samplerate == 48000)) {
				ret = tas256x_i2c_load_data(p_tas256x, i+1,
	...
	int chn)
{
	...
	if ((value >= 0) && (value < 85)) {
		if (chn == channel_both) {
			for (i = 0; i < p_tas256x->mn_channels; i++) {
				ret = p_tas256x->bulk_write(p_tas256x, i+1,
					TAS256X_ICN_THRESHOLD_REG,
					(char *)&(icn_thr[value][0]), sizeof(int));
				if (ret == 0)
					p_tas256x->devs[i]->icn_thr = value;	
			}
		} else {
			ret = p_tas256x->bulk_write(p_tas256x, chn,
				TAS256X_ICN_THRESHOLD_REG,
				(char *)&(icn_thr[value][0]), sizeof(int));
			if (ret == 0)
				p_tas256x->devs[chn-1]->icn_thr = value;			
		}
	}
		...
		if (chn == channel_both) {
			for (i = 0; i < p_tas256x->mn_channels; i++) {
				ret = p_tas256x->bulk_write(p_tas256x, i+1,
					...
					data, sizeof(int));
				if (ret == 0)
					p_tas256x->devs[i]->icn_hyst = value;
			}
		} else {
			ret = p_tas256x->bulk_write(p_tas256x, chn,
				TAS256X_ICN_HYSTERESIS_REG,
				data, sizeof(int));
			if (ret == 0)
				p_tas256x->devs[chn-1]->icn_hyst = value;		
		}
	}
