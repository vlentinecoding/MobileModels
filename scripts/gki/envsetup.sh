...
HONOR_FRAG=${CONFIGS_DIR}/${PLATFORM_NAME}_HONOR.config
HONOR_DEBUG_FRAG=${CONFIGS_DIR}/${PLATFORM_NAME}_HONOR_debug.config
HONOR_FACTORY_FRAG=${CONFIGS_DIR}/${PLATFORM_NAME}_HONOR_factory.config
HONOR_KASAN_FRAG=${CONFIGS_DIR}/${PLATFORM_NAME}_HONOR_kasan.config
HONOR_GKI_FRAG=${CONFIGS_DIR}/${PLATFORM_NAME}_HONOR_gki.config
...
export ARCH CROSS_COMPILE REAL_CC HOSTCC HOSTLD HOSTAR KERN_SRC KERN_OUT \
	...
	HONOR_FRAG HONOR_DEBUG_FRAG HONOR_FACTORY_FRAG HONOR_KASAN_FRAG HONOR_GKI_FRAG
