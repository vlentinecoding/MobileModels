...
/**
 * hbm mode supported by the SDE connectors.
 */
#define HBM_MODE_ON		0
#define HBM_MODE_OFF	1
...
/**
 * struct display_engine_ddic_hbm_param:  hbm feature
 * @type: hbm type, 0:fp   1:MMI   2:light.
 * @level: hbm level.
 * @dimming: dimming switch.
 */
...
/* hbm feature */
#define DRM_MSM_DISPLAY_HBM            0x46
...
/* hbm feature */
#define DRM_IOCTL_MSM_DISPLAY_HBM DRM_IOW((DRM_COMMAND_BASE + \
			DRM_MSM_DISPLAY_HBM), struct display_engine_ddic_hbm_param)
