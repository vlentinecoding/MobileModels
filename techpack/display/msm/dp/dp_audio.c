...
static void dp_audio_setup_acr(struct dp_audio_private *audio)
{
	...
	DP_INFO("bw_code %u, select %u\n", audio->dp_audio.bw_code, select);
	catalog->data = select;
	...
	struct msm_ext_disp_audio_setup_params *params)
{
	...
	DP_INFO("sample_rate_hz %u, num_of_channels %u\n",
		params->sample_rate_hz, params->num_of_channels);
	...
	DP_INFO("audio stream configured\n");
