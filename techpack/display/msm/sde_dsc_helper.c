...
static char sde_dsc_rc_range_min_qp1[DSC_RATIO_TYPE_MAX][DSC_NUM_BUF_RANGES] = {
	/* DSC v1.1 */
	{0, 0, 1, 1, 3, 3, 3, 3, 3, 3, 5, 5, 5, 7, 13},
	{0, 4, 5, 5, 7, 7, 7, 7, 7, 7, 9, 9, 9, 11, 17},
	{0, 4, 5, 6, 7, 7, 7, 7, 7, 7, 9, 9, 9, 11, 15},
...
static char sde_dsc_rc_range_max_qp1[DSC_RATIO_TYPE_MAX][DSC_NUM_BUF_RANGES] = {
	/* DSC v1.1 */
	{4, 4, 5, 6, 7, 7, 7, 8, 9, 10, 11, 12, 13, 13, 15},
	{4, 8, 9, 10, 11, 11, 11, 12, 13, 14, 15, 16, 17, 17, 19},
	{7, 8, 9, 10, 11, 11, 11, 12, 13, 13, 14, 14, 15, 15, 16},
...
static char sde_dsc_rc_range_bpg1[DSC_RATIO_TYPE_MAX][DSC_NUM_BUF_RANGES] = {
	/* DSC v1.1 */
	{2, 0, 0, -2, -4, -6, -8, -8, -8, -10, -10, -12, -12, -12, -12},
	{2, 0, 0, -2, -4, -6, -8, -8, -8, -10, -10, -12, -12, -12, -12},
	{2, 0, 0, -2, -4, -6, -8, -8, -8, -10, -10, -10, -12, -12, -12},
...
int sde_dsc_populate_dsc_config(struct drm_dsc_config *dsc, int scr_ver, bool change_pps) {
	int bpp, bpc;
	...
	if (change_pps) {
		for (i = 0; i < DSC_NUM_BUF_RANGES; i++) {
			dsc->rc_range_params[i].range_min_qp =
				sde_dsc_rc_range_min_qp1[ratio_idx][i];
			dsc->rc_range_params[i].range_max_qp =
				sde_dsc_rc_range_max_qp1[ratio_idx][i];
			dsc->rc_range_params[i].range_bpg_offset =
				sde_dsc_rc_range_bpg1[ratio_idx][i];
			}
	} else {
		for (i = 0; i < DSC_NUM_BUF_RANGES; i++) {
			dsc->rc_range_params[i].range_min_qp =
