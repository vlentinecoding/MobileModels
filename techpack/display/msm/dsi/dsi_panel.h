...
struct dsi_panel {
	...
	/* skip normal backlight set when on aod scene */
	bool skip_normal_bl_set_on_aod;
...
#ifdef CONFIG_LCD_QCOM_DRV
int dsi_panel_receive_data(struct dsi_panel *panel,
		int type, u8 *recv_buf, u32 recv_buf_len);
