...
#define HWCAM_V4L2_IOCTL_REQUEST_ACK32 _IOW('A', \
	BASE_VIDIOC_PRIVATE + 0x20, struct v4l2_event32)
#define HWCAM_V4L2_IOCTL_NOTIFY32 _IOW('A', \
	BASE_VIDIOC_PRIVATE + 0x21, struct v4l2_event32)
#define HWCAM_V4L2_IOCTL_THERMAL_GUARD32 _IOWR('A', \
...
#define HWCAM_V4L2_IOCTL_GET_BUF32 _IOR('A', \
	BASE_VIDIOC_PRIVATE + 0x06, hwcam_buf_status_t32)
#define HWCAM_V4L2_IOCTL_PUT_BUF32 _IOW('A', \
	BASE_VIDIOC_PRIVATE + 0x07, hwcam_buf_status_t32)
#define HWCAM_V4L2_IOCTL_BUF_DONE32 _IOW('A', \
	BASE_VIDIOC_PRIVATE + 0x08, hwcam_buf_status_t32)
