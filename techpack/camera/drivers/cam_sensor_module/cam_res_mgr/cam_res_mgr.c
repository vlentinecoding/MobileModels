...
extern bool g_flash_thermal_protect_status;
#endif
...
#ifndef CONFIG_HONOR_GKI_V1
	if(g_flash_thermal_protect_status == true && brightness != LED_OFF) {
		CAM_WARN(CAM_FLASH, "Cannot apply Start Dev:thermal protect enable");
		return;
	}
#endif
