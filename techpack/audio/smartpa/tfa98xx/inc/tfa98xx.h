...
#define ENABLE_DYNAMIC_BATTERY_PROTECTION_FTR
...
struct tfa98xx_battery_protection_rule {
	uint16_t  temperature_threadhold_low;
	uint16_t  temperature_threadhold_high;
	uint16_t  powerenergy_threadhold_low;
	uint16_t  powerenergy_threadhold_high;
	uint16_t  value;
};
#endif
...
struct tfa98xx {
	...
	uint16_t cal_data;
#ifdef ENABLE_DYNAMIC_BATTERY_PROTECTION_FTR
	uint16_t battery_protection_data;
#endif
};
