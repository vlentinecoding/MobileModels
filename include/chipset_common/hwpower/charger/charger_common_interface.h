...
static inline int charge_set_jeita_ichg(unsigned int value)
{
	return 0;
}

static inline int charge_set_jeita_vterm(unsigned int value)
{
	return 0;
}
...
static inline void charge_set_pd_charge_flag(bool flag)
{
}

static inline bool charge_get_pd_charge_flag(void)
{
	return false;
}

static inline void charge_set_pd_init_flag(bool flag)
{
}

static inline bool charge_get_pd_init_flag(void)
{
	return false;
}
