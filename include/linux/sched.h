...
#ifdef CONFIG_FUSE_DAEMON_FLAG
#define PFA_FUSE_DAEMON 28
#endif
...
#ifdef CONFIG_FUSE_DAEMON_FLAG
TASK_PFA_TEST(FUSE_DAEMON, fuse_daemon)
TASK_PFA_SET(FUSE_DAEMON, fuse_daemon)
TASK_PFA_CLEAR(FUSE_DAEMON, fuse_daemon)
#endif
