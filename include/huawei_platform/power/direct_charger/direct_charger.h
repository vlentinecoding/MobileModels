...
struct direct_charge_device {
	...
	int cam_flash_stop;
	int cam_flash_enable_path;
	int flash_ovp_off_gpio;
	int error_cnt;
...
static inline int direct_charge_switch_path_to_dc_charging(int hv_flag)
{
	return -1;
}
...
static inline void hsc_get_fault_notifier(struct atomic_notifier_head **notifier)
{
}
...
static inline void hsc_set_ignore_full_res(bool flag)
{
}

static inline int hsc_get_di(struct direct_charge_device **di)
{
}
