...
int hihonor_charger_glink_set_iin_thermal(int *iin_thermal_array, int array_size);
#else
...
static inline int hihonor_charger_glink_set_iin_thermal(int *iin_thermal_array, int array_size)
{
	return -1;
}
