...
enum hlos_aggregator_client {
	HLOS_AGGREGATOR_BEGIN = 0,
	HLOS_AGGREGATOR_RT = HLOS_AGGREGATOR_BEGIN,
	HLOS_AGGREGATOR_THERMAL,
	HLOS_AGGREGATOR_WLS,
	HLOS_AGGREGATOR_JEITA,
	HLOS_AGGREGATOR_FCP_ICL,
	HLOS_AGGREGATOR_END,
};
...
int power_glink_get_buck_charge_done_flag(void);
...
static inline int power_glink_get_buck_charge_done_flag(void)
{
	return 0;
}
