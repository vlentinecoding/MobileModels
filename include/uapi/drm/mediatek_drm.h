...
/* PQ */
#define C_TUN_IDX 36 /* COLOR_TUNING_INDEX */
#define COLOR_TUNING_INDEX 36
...
#define CCORR_COEF_CNT 17 /* ccorr feature */
...
struct IoPqIndex {
    unsigned long pqindex;
};

typedef struct IoPqIndex PQIndexTable;
...
/* SHARE MEM */
#define DRM_DISPLAY_ENGINE_SHAREMEM_GET 0x45
#define DRM_DISPLAY_ENGINE_SHAREMEM_SET 0x46
#define DRM_DISPLAY_ENGINE_SHAREMEM_STATUS_GET 0x47
#endif
...
#define DRM_IOCTL_MTK_SET_PQINDEX     DRM_IOWR(DRM_COMMAND_BASE + \
		DRM_MTK_SET_PQINDEX, struct IoPqIndex)
...
#define DRM_IOCTL_DISPLAY_ENGINE_SHAREMEM_GET	DRM_IOWR(DRM_COMMAND_BASE + \
		DRM_DISPLAY_ENGINE_SHAREMEM_GET, struct display_engine_share_memory)

#define DRM_IOCTL_DISPLAY_ENGINE_SHAREMEM_SET	DRM_IOWR(DRM_COMMAND_BASE + \
		DRM_DISPLAY_ENGINE_SHAREMEM_SET, struct display_engine_share_memory_param)

#define DRM_IOCTL_DISPLAY_ENGINE_SHAREMEM_STATUS_GET	DRM_IOWR(DRM_COMMAND_BASE + \
		DRM_DISPLAY_ENGINE_SHAREMEM_STATUS_GET, struct display_engine_share_memory_status)
#endif
