/*
 * Copyright (c) Honor Technologies Co., Ltd. 2018-2018. All rights reserved.
 * Description: the hw_kernel_stp_module.c for kernel stp module init and deinit
 * Author: sunhongqing <sunhongqing@honor.com>
 * Create: 2018-03-31
 */
...
MODULE_AUTHOR("sunhongqing <sunhongqing@honor.com>");
