 ...
 * hkip_atkinfo.h
 *
 * Honor HKIP driver to upload attack process information.
 *
 * Copyright (c) 2017-2019 Honor Technologies Co., Ltd.
 *
 * HKIP is the kernel integrity protection developed by Honor.
